...
final class o {
   ...
   public static int a(o var0, int[] var1, int[] var2, int[] var3, int[] var4, j var5) {
      ...
      if (var0.g == null) {
         ...
         do {
            if (var0.g[var7][0] == 0) {
               var1[0] = var0.g[var7][1] >>> 4;
               var2[0] = var0.g[var7][1] & 15;
               var8 = 0;
               break;
            }

            if (var5.b() != 0) {
               while(var0.g[var7][1] >= 250) {
                  var7 += var0.g[var7][1];
               }

               var7 += var0.g[var7][1];
            } else {
               while(var0.g[var7][0] >= 250) {
                  var7 += var0.g[var7][0];
               }

               var7 += var0.g[var7][0];
            }
         } while((var6 >>>= 1) != 0 || var7 < 0);

         if (var0.b != '3' || var0.c != '2' && var0.c != '3') {
            if (var0.f != 0 && var0.d - 1 == var1[0]) {
               var1[0] += var5.a(var0.f);
            }

            if (var1[0] != 0 && var5.b() != 0) {
               var1[0] = -var1[0];
            }

            if (var0.f != 0 && var0.e - 1 == var2[0]) {
               var2[0] += var5.a(var0.f);
            }

            if (var2[0] != 0 && var5.b() != 0) {
               var2[0] = -var2[0];
            }
         } else {
            var3[0] = var2[0] >> 3 & 1;
            ...
            var1[0] = var2[0] >> 1 & 1;
            var2[0] &= 1;
            if (var3[0] != 0 && var5.b() != 0) {
               var3[0] = -var3[0];
            }

            if (var4[0] != 0 && var5.b() != 0) {
               var4[0] = -var4[0];
            }
   ...
   public static void a() {
      if (a == null) {
         (a = new o[34])[0] = new o("0  ", 0, 0, 0, 0, -1, (int[])null, (int[])null, i, 0);
         a[1] = new o("1  ", 2, 2, 0, 0, -1, (int[])null, (int[])null, j, 7);
         a[2] = new o("2  ", 3, 3, 0, 0, -1, (int[])null, (int[])null, k, 17);
         a[3] = new o("3  ", 3, 3, 0, 0, -1, (int[])null, (int[])null, l, 17);
         a[4] = new o("4  ", 0, 0, 0, 0, -1, (int[])null, (int[])null, m, 0);
         a[5] = new o("5  ", 4, 4, 0, 0, -1, (int[])null, (int[])null, n, 31);
         a[6] = new o("6  ", 4, 4, 0, 0, -1, (int[])null, (int[])null, o, 31);
         a[7] = new o("7  ", 6, 6, 0, 0, -1, (int[])null, (int[])null, p, 71);
         a[8] = new o("8  ", 6, 6, 0, 0, -1, (int[])null, (int[])null, q, 71);
         a[9] = new o("9  ", 6, 6, 0, 0, -1, (int[])null, (int[])null, r, 71);
         a[10] = new o("10 ", 8, 8, 0, 0, -1, (int[])null, (int[])null, s, 127);
         a[11] = new o("11 ", 8, 8, 0, 0, -1, (int[])null, (int[])null, t, 127);
         a[12] = new o("12 ", 8, 8, 0, 0, -1, (int[])null, (int[])null, u, 127);
         a[13] = new o("13 ", 16, 16, 0, 0, -1, (int[])null, (int[])null, v, 511);
         a[14] = new o("14 ", 0, 0, 0, 0, -1, (int[])null, (int[])null, w, 0);
         a[15] = new o("15 ", 16, 16, 0, 0, -1, (int[])null, (int[])null, x, 511);
         a[16] = new o("16 ", 16, 16, 1, 1, -1, (int[])null, (int[])null, y, 511);
         a[17] = new o("17 ", 16, 16, 2, 3, 16, (int[])null, (int[])null, y, 511);
         a[18] = new o("18 ", 16, 16, 3, 7, 16, (int[])null, (int[])null, y, 511);
         a[19] = new o("19 ", 16, 16, 4, 15, 16, (int[])null, (int[])null, y, 511);
         a[20] = new o("20 ", 16, 16, 6, 63, 16, (int[])null, (int[])null, y, 511);
         a[21] = new o("21 ", 16, 16, 8, 255, 16, (int[])null, (int[])null, y, 511);
         a[22] = new o("22 ", 16, 16, 10, 1023, 16, (int[])null, (int[])null, y, 511);
         a[23] = new o("23 ", 16, 16, 13, 8191, 16, (int[])null, (int[])null, y, 511);
         a[24] = new o("24 ", 16, 16, 4, 15, -1, (int[])null, (int[])null, z, 512);
         a[25] = new o("25 ", 16, 16, 5, 31, 24, (int[])null, (int[])null, z, 512);
         a[26] = new o("26 ", 16, 16, 6, 63, 24, (int[])null, (int[])null, z, 512);
         a[27] = new o("27 ", 16, 16, 7, 127, 24, (int[])null, (int[])null, z, 512);
         a[28] = new o("28 ", 16, 16, 8, 255, 24, (int[])null, (int[])null, z, 512);
         a[29] = new o("29 ", 16, 16, 9, 511, 24, (int[])null, (int[])null, z, 512);
         a[30] = new o("30 ", 16, 16, 11, 2047, 24, (int[])null, (int[])null, z, 512);
         a[31] = new o("31 ", 16, 16, 13, 8191, 24, (int[])null, (int[])null, z, 512);
         a[32] = new o("32 ", 1, 16, 0, 0, -1, (int[])null, (int[])null, A, 31);
         a[33] = new o("33 ", 1, 16, 0, 0, -1, (int[])null, (int[])null, B, 31);
      }
   }
}
